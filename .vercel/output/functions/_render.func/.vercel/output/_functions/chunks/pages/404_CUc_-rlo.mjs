/* empty css                          */
import { c as createAstro, d as createComponent, r as renderTemplate, e as addAttribute, f as renderSlot, g as renderHead, h as renderComponent, m as maybeRenderHead, F as Fragment, u as unescapeHTML } from '../astro_BGXLXoF4.mjs';
import 'kleur/colors';
/* empty css                           */
import 'clsx';
/* empty css                        */
...
}, "C:/Users/sigur/Documents/dev/astro-blog/node_modules/astro/components/ViewTransitions.astro", void 0);
...
const $$Layout = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Layout;
  const googleSiteVerification = {"BASE_URL": "/", "MODE": "production", "DEV": false, "PROD": true, "SSR": true, "SITE": "https://www.kalmanodds.com/", "ASSETS_PREFIX": undefined}.PUBLIC_GOOGLE_SITE_VERIFICATION;
  const {
    title = SITE.title,
    author = SITE.author,
...
}, "C:/Users/sigur/Documents/dev/astro-blog/src/layouts/Layout.astro", void 0);
...
}, "C:/Users/sigur/Documents/dev/astro-blog/src/components/Hr.astro", void 0);
...
const $$LinkButton = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const { href, className, ariaLabel, title, disabled = false, openInNewTab = false } = Astro2.props;
  return renderTemplate`${maybeRenderHead()}<a${addAttribute(disabled ? "#" : href, "href")}${addAttribute(disabled ? "-1" : "0", "tabindex")}${addAttribute(`group inline-block ${className}`, "class")}${addAttribute(ariaLabel, "aria-label")}${addAttribute(title, "title")}${addAttribute(disabled, "aria-disabled")}${addAttribute(openInNewTab ? "_blank" : void 0, "target")} data-astro-cid-5eunqzkt> ${renderSlot($$result, $$slots["default"])} </a> `;
}, "C:/Users/sigur/Documents/dev/astro-blog/src/components/LinkButton.astro", void 0);
...
const $$Header = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<header data-astro-cid-3ef6ksr2> <a id="skip-to-content" href="#main-content" data-astro-cid-3ef6ksr2>Skip to content</a> <div class="nav-container" data-astro-cid-3ef6ksr2> <div class="top-nav-wrap" data-astro-cid-3ef6ksr2> <a href="/" class="logo" data-astro-cid-3ef6ksr2>${SITE.title}</a> <nav id="nav-menu" data-astro-cid-3ef6ksr2> <button class="hamburger-menu focus-outline" aria-label="Open Menu" aria-expanded="false" aria-controls="menu-items" data-astro-cid-3ef6ksr2> <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" class="menu-icon" data-astro-cid-3ef6ksr2> <line x1="7" y1="12" x2="21" y2="12" class="line" data-astro-cid-3ef6ksr2></line> <line x1="3" y1="6" x2="21" y2="6" class="line" data-astro-cid-3ef6ksr2></line> <line x1="12" y1="18" x2="21" y2="18" class="line" data-astro-cid-3ef6ksr2></line> <line x1="18" y1="6" x2="6" y2="18" class="close" data-astro-cid-3ef6ksr2></line> <line x1="6" y1="6" x2="18" y2="18" class="close" data-astro-cid-3ef6ksr2></line> </svg> </button> <ul id="menu-items" class="display-none sm:flex" data-astro-cid-3ef6ksr2> <li data-astro-cid-3ef6ksr2> <a href="/projects"${addAttribute(activeNav === "projects" ? "active" : "", "class")} data-astro-cid-3ef6ksr2>
Portfolio
...
const $$Socials = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<div${addAttribute(`flex-wrap justify-center gap-1 ${centered ? "flex" : ""}`, "class")}> ${SOCIALS.filter((social) => social.active).map((social) => renderTemplate`${renderComponent($$result, "LinkButton", $$LinkButton, { "href": social.href, "className": "p-2 hover:rotate-6 sm:p-1", "title": social.linkTitle, "openInNewTab": true }, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "Fragment", Fragment, {}, { "default": ($$result3) => renderTemplate`${unescapeHTML(socialIcons[social.name])}` })} ` })}`)} </div>`;
}, "C:/Users/sigur/Documents/dev/astro-blog/src/components/Socials.astro", void 0);
...
}, "C:/Users/sigur/Documents/dev/astro-blog/src/components/Footer.astro", void 0);

const $$Astro = createAstro("https://www.kalmanodds.com/");
const $$404 = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro, $$props, $$slots);
  Astro2.self = $$404;
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": `404 Not Found | ${SITE.title}`, "data-astro-cid-zetdm5md": true }, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "Header", $$Header, { "data-astro-cid-zetdm5md": true })} ${maybeRenderHead()}<main id="main-content" data-astro-cid-zetdm5md> <div class="not-found-wrapper" data-astro-cid-zetdm5md> <h1 aria-label="404 Not Found" data-astro-cid-zetdm5md>404</h1> <span aria-hidden="true" data-astro-cid-zetdm5md>¯\\_(ツ)_/¯</span> <p data-astro-cid-zetdm5md>Page Not Found</p> ${renderComponent($$result2, "LinkButton", $$LinkButton, { "href": "/", "className": "my-6 underline decoration-dashed underline-offset-8 text-lg", "data-astro-cid-zetdm5md": true }, { "default": ($$result3) => renderTemplate`
Go back home
` })} </div> </main> ${renderComponent($$result2, "Footer", $$Footer, { "data-astro-cid-zetdm5md": true })} ` })} `;
}, "C:/Users/sigur/Documents/dev/astro-blog/src/pages/404.astro", void 0);

const $$file = "C:/Users/sigur/Documents/dev/astro-blog/src/pages/404.astro";
const $$url = "/404";
...
export { $$Header as $, LOCALE as L, SITE as S, _404 as _, $$LinkButton as a, $$Footer as b, $$Layout as c, SOCIALS as d, $$Socials as e, $$Hr as f };
